...
const dict = {
  es: {
    ...
    settings: {
      ...
      currency: 'Moneda',
      fxRate: 'Tasa UYU → USD',
      fxRateDesc: 'Conversión automática desde la API (UYU por 1 USD).',
      fxProvider: 'Proveedor',
      fxUpdatedAt: 'Actualizado',
      fxCached: 'Cacheado',
      fxStale: 'Desactualizada',
      fxRefresh: 'Actualizar tasa',
      fxUpdated: 'Tasa actualizada',
      fxUpdateFailed: 'No se pudo actualizar la tasa',
  ...
  en: {
    ...
    settings: {
      ...
      currency: 'Currency',
      fxRate: 'Rate UYU → USD',
      fxRateDesc: 'Automatic conversion from API (UYU per 1 USD).',
      fxProvider: 'Provider',
      fxUpdatedAt: 'Updated',
      fxCached: 'Cached',
      fxStale: 'Stale',
      fxRefresh: 'Refresh rate',
      fxUpdated: 'Rate updated',
      fxUpdateFailed: 'Failed to update rate',
