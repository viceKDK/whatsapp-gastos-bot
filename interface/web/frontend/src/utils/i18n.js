...
const dict = {
  es: {
    ...
    settings: {
      ...
      currency: 'Moneda',
      fxRate: 'Tasa UYU → USD',
      fxRateDesc: 'Se usará para convertir montos de UYU a USD en la interfaz. Valor esperado: UYU por 1 USD (ej.: 40).',
  ...
  en: {
    ...
    settings: {
      ...
      currency: 'Currency',
      fxRate: 'Rate UYU → USD',
      fxRateDesc: 'Used to convert UYU amounts to USD in the UI. Expected value: UYU per 1 USD (e.g., 40).',
